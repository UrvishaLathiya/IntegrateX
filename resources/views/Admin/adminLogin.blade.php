...
<body>
    <div class="d-flex justify-content-center align-items-center vh-100">
        <div class="form-container">
            {{-- @if (session('success'))
                <div id="success-message" class="alert alert-primary text-center" role="alert">
                    {{ session('success') }}
                </div>
            @endif --}}
            <div class="showError"> 
            ...
            <form action="{{ route('adminLogin') }}" method="POST">
                ...
                {{-- <div class="d-flex justify-content-between align-items-center mb-3">
                    <a href="#" class="text-primary txtAdmin">Forgot Password</a>
                </div> --}}
                <button type="submit" class="btn btn-primary w-100 py-2">Sign In</button>
            </form>
            {{-- <p class="text-center mt-3 txtAdmin">Don't have an Account? <a href="#" class="text-primary txtAdmin">Sign Up</a></p> --}}
        </div>
    </div>
    <script>
