...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('officerAssets/css/vendors/css/vendor.bundle.base.css')}}">
  <!-- endinject -->
  <!-- Plugin css for this page -->
  <link rel="stylesheet" href="{{ asset('officerAssets/css/vendors/datatables.net-bs4/dataTables.bootstrap4.css')}}">
  <link rel="stylesheet" href="{{ asset('officerAssets/css/vendors/ti-icons/css/themify-icons.css')}}">
  <link rel="stylesheet" type="{{ asset('officerAssets/css/text/css" href="js/select.dataTables.min.css')}}">
